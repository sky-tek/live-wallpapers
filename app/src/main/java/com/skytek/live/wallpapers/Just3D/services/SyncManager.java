package com.skytek.live.wallpapers.Just3D.services;
...
import static com.skytek.live.wallpapers.Just3D.Constants.LD_CATALOG;
import static com.skytek.live.wallpapers.Just3D.Constants.LD_TIMESTAMP;
import static com.skytek.live.wallpapers.Just3D.Constants.PACKAGE_NAME;
...
//                        showNotification(newCount);
    ...
    private void showNotification(int newCount) {
        ...
        Intent disableIntent = new Intent(this, MainActivity3d.class);
        disableIntent.putExtra(MainActivity3d.EXTRA_DISABLE_NOTIFICATION, true);

        Intent startIntent = new Intent(this, MainActivity3d.class);
        ...
        builder.setSmallIcon(R.drawable.icon_sirf3d);
