...
public class Constants {
    ...
    public final static String URL_API = "https://mobipixels.net/3D/";

    public final static String PACKAGE_NAME = "com.example.livewallpaper3d";
